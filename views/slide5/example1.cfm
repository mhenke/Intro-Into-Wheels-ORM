...
<span style='color: Teal; background-color: '>  4</span>         &lt;cfset user = model(<span style=' color: Maroon;'>"user2"</span>).findOneByEmailAndPassword(<span style=' color: Maroon;'>"henke.mike@gmail.com,password"</span>)&gt;
...
<span style='color: Teal; background-color: '>  8</span>             users = model(<span style=' color: Maroon;'>"user2"</span>).findAllByAgeAndFirstName(
